...
class SearchPage extends StatelessWidget {
  ...
  Widget _buildBodyContent(BuildContext context, SearchViewModel viewModel){
    if(viewModel.state == SearchViewState.initial){
      return Center(child: 
      Text('Digite um nome de receita para começar a busca!',
    ...
    if(viewModel.state == SearchViewState.error || viewModel.searchResults.isEmpty){
      return Center(
        child: Padding(padding: EdgeInsets.all(AppConstants.paddingLarge),
        child: Text(
